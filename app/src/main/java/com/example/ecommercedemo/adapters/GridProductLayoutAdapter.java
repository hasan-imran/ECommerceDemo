...
//            view.setBackgroundColor(Color.parseColor("#ffffff"));
            ...
            ImageView tvProductImage = view.findViewById(R.id.ivHorizontalScrollItemImage);
            ...
            tvProductImage.setImageResource(gridProductList.get(position).getHorizontalScrollItemImageLink());
